...
import { 
  ...
  CheckCircle2, Users, TrendingUp, Lock, Smartphone, Cloud, Star
} from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-[#fafcff] overflow-hidden font-sans relative">
      ...
      <nav className="fixed w-full z-50 top-0 pt-4 px-4 sm:px-6 lg:px-8">
        <div className="max-w-[1400px] mx-auto flex items-center justify-between bg-white/70 backdrop-blur-2xl border border-white/60 shadow-[0_15px_40px_-15px_rgba(0,0,0,0.06)] rounded-[2rem] h-[5rem] px-8 sm:px-12">
          <Link to="/" className="flex items-center gap-3">
            <img src={logoImg} alt="Daily Khata Logo" className="h-[2.5rem] w-auto object-contain drop-shadow-sm" />
            <span className="text-[1.6rem] font-black tracking-tighter text-slate-900 hidden sm:block">
              Daily-KHATA
            </span>
          </Link>
          
          <div className="hidden md:flex space-x-2 items-center">
            <a href="#hero" className="px-5 py-2.5 text-[15px] font-bold text-slate-600 hover:text-blue-600 hover:bg-white/60 rounded-2xl transition-all">Home</a>
            <a href="#features" className="px-5 py-2.5 text-[15px] font-bold text-slate-600 hover:text-blue-600 hover:bg-white/60 rounded-2xl transition-all">Platform</a>
            <a href="#testimonials" className="px-5 py-2.5 text-[15px] font-bold text-slate-600 hover:text-blue-600 hover:bg-white/60 rounded-2xl transition-all">Stories</a>
            <Link to="/pricing" className="px-5 py-2.5 text-[15px] font-bold text-slate-600 hover:text-blue-600 hover:bg-white/60 rounded-2xl transition-all">Pricing</Link>
          </div>

          <div className="flex items-center gap-4">
            {/* Direct Admin link disabled per user request */}
          </div>
        </div>
      </nav>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-12 mb-20">
            ...
            <div className="lg:col-span-4">
              <div className="flex items-center gap-3 mb-6 block w-full">
                 ...
                 <span className="text-[1.8rem] font-black tracking-tighter text-white">Daily-KHATA</span>
              </div>
            ...
            <div className="lg:col-span-2 lg:col-start-7">
              ...
              <ul className="space-y-4 text-slate-400 font-medium text-[15px]">
                <li><a href="#features" className="hover:text-white hover:translate-x-1 inline-block transition-all">Feature Grid</a></li>
                <li><Link to="/pricing" className="hover:text-white hover:translate-x-1 inline-block transition-all">Pricing & Tiers</Link></li>
                <li><a href="#" className="hover:text-white hover:translate-x-1 inline-block transition-all">Mobile Application</a></li>
                <li><a href="#" className="hover:text-white hover:translate-x-1 inline-block transition-all">Premium Insights</a></li>
            ...
            <div className="lg:col-span-2">
              ...
              <ul className="space-y-4 text-slate-400 font-medium text-[15px]">
                ...
                <li><a href="#" className="hover:text-white hover:translate-x-1 inline-block transition-all">Community Forums</a></li>
                <li><a href="#" className="hover:text-white hover:translate-x-1 inline-block transition-all">Financial Glossary</a></li>
            ...
            <div className="lg:col-span-2">
              ...
              <ul className="space-y-4 text-slate-400 font-medium text-[15px]">
                ...
                <li><a href="#" className="hover:text-white hover:translate-x-1 inline-block transition-all">Refund Agreement</a></li>
                <li><a href="#" className="hover:text-white hover:translate-x-1 inline-block transition-all">Security Practices</a></li>
              </ul>
            </div>
          </div>
